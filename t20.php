...
<body>
    <header >
        <nav class="navbar">
            <ul>
                ...
                <span class="homie"><li class="lists"><a href="landingPage.php">Home</a></li></span>
    ...
    <main class="main">
    <h1 class="formats">T20 FORMAT</h1>
        <form class="tomiddle" method='POST'>
            ...
            <!-- <fieldset>
                ...
                <input type="checkbox" id="runs" name="lang[]" value="runs" ><label for="runs">Runs</label><br>
                <input type="checkbox" id="average" name="lang[]" value="average" ><label for="average">Average</label><br>
                <input type="checkbox" id="bestScore" name="lang[]" value="bestScore" ><label for="bestScore">Best Score</label><br>
                <input type="checkbox" class="useless"><br>
            </fieldset>
            <fieldset>
                <legend>BOWLING STATS</legend>
                <input type="checkbox" id="wickets" name="lang[]" value="wickets" ><label for="wickets">Wickets</label><br>
                <input type="checkbox" id="economy" name="lang[]" value="economy" ><label for="economy">Economy</label><br>
                <input type="checkbox" class="useless"><br>
                <input type="checkbox" class="useless"><br>
            </fieldset>
            <fieldset>
                <legend>OTHERS</legend>
                <input type="checkbox" id="age" name="lang[]" value="age" ><label for="age">Age</label><br>
                <input type="checkbox" id="nickName" name="lang[]" value="nickName" ><label for="nickName">Nickname</label><br>
                <input type="checkbox" id="jNo" name="lang[]" value="jno" ><label for="jNo">Jersey Number</label><br>
                <input type="checkbox" id="role" name="lang[]" value="role" ><label for="role">Role</label><br>
            </fieldset> -->
            <div class="btns">
                <input type="reset" class="rst" />
                <input type="submit" id="btn" value="View" class="sbmt">
                <br>
            </div>
        </form>
